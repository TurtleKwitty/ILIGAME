...
bool ILIGAME::VM::tickDraw()
{
    ...
    ILIGAME::VM::drawText((char *)gameMemory, 128 + 16 + 4, 3, 0);
    return false;
}
...
void ILIGAME::VM::drawText(char *text, unsigned char x, unsigned char y, unsigned char color)
{
